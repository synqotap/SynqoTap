    ...
    <>
      ...
      <nav id="navbar">
        <div className="container">
          <div className="nav-inner">
            ...
            <a href="#precios" className="nav-cta">Comprar ahora →</a>
          </div>
        </div>
      </nav>
          ...
          <div className="hero-grid">
            <div>
              ...
              <div className="hero-actions reveal reveal-delay-3">
                <a href="#precios" className="btn-primary">Conseguir mi tarjeta →</a>
        ...
        <div className="container">
          ...
          <div className="products-grid">
            <div className="product-card reveal reveal-delay-1">
              ...
              <a href="#" className="btn-buy btn-buy-outline">Comprar PVC →</a>
            </div>
            <div className="product-card featured reveal reveal-delay-2">
              ...
              <a href="#" className="btn-buy btn-buy-primary">Comprar Metal →</a>
            </div>
            <div className="product-card reveal reveal-delay-3">
              ...
              <a href="#" className="btn-buy btn-buy-outline">Contactar →</a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="demo-grid">
            <div className="reveal">
              ...
              <div style={{display:'flex',flexDirection:'column',gap:'14px'}}>
                {['Carga en menos de 1 segundo','Sin apps ni descargas para quien te escanea','Edita en tiempo real desde tu portal','Tu URL: smartcard.io/c/tu-nombre'].map((item,i) => (
              ...
              <div className="profile-preview">
                ...
                <div className="profile-buttons">
                  {[
                    ...
                    {icon:'in',label:'LinkedIn',bg:'rgba(10,102,194,0.15)'},
                  ].map((btn,i) => (
      ...
      <section className="cta-section">
        <div className="container">
          ...
          <a href="#precios" className="btn-primary reveal reveal-delay-2" style={{display:'inline-flex'}}>Empezar ahora — desde $39 →</a>
        </div>
      </section>
        ...
        <div className="container">
          <div className="footer-grid">
            <div className="footer-brand">
              <div className="logo">Smart<span style={{color:'var(--cyan)'}}>Card</span></div>
              <p>La tarjeta de presentación del futuro. NFC + perfil digital ilimitado, un solo pago.</p>
            </div>
            <div className="footer-col"><h4>Producto</h4><ul><li><a href="#">Tarjeta PVC</a></li><li><a href="#">Tarjeta Metal</a></li><li><a href="#">Empresas</a></li><li><a href="#">Demo</a></li></ul></div>
            <div className="footer-col"><h4>Info</h4><ul><li><a href="#">Cómo funciona</a></li><li><a href="#">Precios</a></li><li><a href="#">FAQ</a></li><li><a href="#">Contacto</a></li></ul></div>
            <div className="footer-col"><h4>Cuenta</h4><ul><li><a href="#">Entrar</a></li><li><a href="#">Mi perfil</a></li><li><a href="#">Mis pedidos</a></li><li><a href="#">Soporte</a></li></ul></div>
          </div>
          <div className="footer-bottom">
            <span>© 2025 SmartCard. Todos los derechos reservados.</span>
