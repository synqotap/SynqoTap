        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 sm:gap-16 items-center">
            ...
            <div className="max-w-xs mx-auto w-full rounded-3xl overflow-hidden border border-[#22223A]" style={{background:'#07070C'}}>
              {/* Cover — dark, no cyan */}
              <div className="relative" style={{height:'80px',background:'linear-gradient(180deg,#1C1C2E 0%,#13131F 100%)'}}>
                <div style={{position:'absolute',inset:0,background:'radial-gradient(ellipse at 50% 0%,rgba(0,229,255,0.06) 0%,transparent 70%)'}}/>
              </div>
              {/* Avatar overlapping cover */}
              <div className="px-5 flex items-end justify-between" style={{marginTop:'-36px',position:'relative',zIndex:1}}>
                <div className="w-18 h-18 rounded-full flex items-center justify-center font-black text-xl text-white flex-shrink-0" style={{width:'72px',height:'72px',background:'linear-gradient(135deg,#00E5FF,#7B61FF)',border:'3px solid #07070C',fontFamily:"'Syne',sans-serif",position:'relative',zIndex:2}}>AR</div>
